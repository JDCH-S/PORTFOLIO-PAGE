...
export default function DesktopLayout() {
  return (
    <div className="relative z-10 grid h-dvh grid-cols-[minmax(280px,1fr)_minmax(420px,1.35fr)_minmax(280px,1fr)] grid-rows-[auto_minmax(0,1fr)_auto] gap-4 p-5 xl:gap-6 xl:p-7">
      ...
      <footer className="col-span-3 flex items-center justify-between gap-6 border-t border-steel-line pt-3">
        <Telemetry />
        <p className="label hidden text-steel-dim md:block">tab · enter · esc</p>
      </footer>
      <Beams />
    </div>
  );
