/** Deterministic PRNG (mulberry32) so a given seed always builds the same sphere. */
...
/* 3D simplex noise (Stefan Gustavson, public domain), seeded permutation. */
const GRAD3 = [
...
export function makeSimplex3(seed: number) {
